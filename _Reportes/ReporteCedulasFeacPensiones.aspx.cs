...
{
    public partial class ReporteCedulasFeacPensiones : System.Web.UI.Page
    {
        ...
        private void ReporteBase()
        {
            ...
            rvReporteCedulasFeacPensiones.ServerReport.ReportServerCredentials = new CredencialesReporteria("rss", "Passw0rd");
            rvReporteCedulasFeacPensiones.ServerReport.ReportServerUrl = new Uri("http://10.30.3.190/reportserver");
            rvReporteCedulasFeacPensiones.ServerReport.ReportPath = "/FIRMAS/ReporteCedulasFeacPensiones";
            rvReporteCedulasFeacPensiones.ShowParameterPrompts = true;
            ...
            rvReporteCedulasFeacPensiones.ServerReport.SetParameters(ColeccionDeParametrosTicket);
            rvReporteCedulasFeacPensiones.ServerReport.Refresh();

            Warning[] warnings;
            string[] streamids;
            string mimeType, encoding, extension;
            byte[] bytes = rvReporteCedulasFeacPensiones.ServerReport.Render("PDF", string.Empty, out mimeType, out encoding, out extension, out streamids, out warnings);

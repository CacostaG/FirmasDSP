...
{
    public partial class ConsultaFEAC : System.Web.UI.Page
    {
        ...
        public void ParametrosFEAC()
        {
            ddlJuris.Items.Clear();
            ddlJuris.Items.Add("Selecciona");
            ddlJuris.Items.Add("TODAS");
            SqlCommand cmdJuris = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPJuris ", conexionBD);
        ...
        protected void ddlJuris_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdAnio = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPAnio", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdAnio = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPAnio @claveJurisFEAC='" + ddlJuris.Text + "'", conexionBD);
                SqlDataAdapter sdaAnio = new SqlDataAdapter(cmdAnio);
                DataTable dtAnio = new DataTable();
                sdaAnio.Fill(dtAnio);
                ddlAnio.DataSource = dtAnio;
        ...
        protected void ddlAnio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdQnaSJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPQna @anioFEAC ='" + ddlAnio.Text + "'", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdQnaCJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPQna @anioFEAC ='" + ddlAnio.Text + "', @claveJurisFEAC ='" + ddlJuris.Text + "'", conexionBD);
        ...
        protected void ddlQna_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdNomiSJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPNomina @anioFEAC ='" + ddlAnio.Text + "', @qnaFEAC ='" + ddlQna.Text + "'", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdNomiCJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPNomina @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@claveJurisFEAC ='" + ddlJuris.Text + "'", conexionBD);
        ...
        protected void ddlNomina_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdUrSJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPUR @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "'", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdUrCJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPUR @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "',@claveJurisFEAC = '" + ddlJuris.Text + "'", conexionBD);
        ...
        protected void ddlUr_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdPrdSJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPPrd @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "',@urFEAC = '" + ddlUr.Text + "'", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdPrdCJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPPrd @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "',@urFEAC = '" + ddlUr.Text + "', @claveJurisFEAC='" + ddlJuris.Text + "'", conexionBD);
        ...
        protected void ddlPrd_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlJuris.SelectedItem.Text == "TODAS")
            {
                ...
                SqlCommand cmdInstSJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPInstru @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "',@urFEAC = '" + ddlUr.Text + "', @prdFEAC='" + ddlPrd.Text + "'", conexionBD);
            ...
            else
            {
                ...
                SqlCommand cmdInstCJ = new SqlCommand("Pry1015_ListadoFirmasFEAC_SPInstru @anioFEAC ='" + ddlAnio.Text + "',@qnaFEAC ='" + ddlQna.Text + "',@nominaFEAC='" + ddlNomina.Text + "',@urFEAC = '" + ddlUr.Text + "', @prdFEAC='" + ddlPrd.Text + "', @claveJurisFEAC ='" + ddlJuris.Text + "'", conexionBD);
        ...
        protected void BindGridView()
        {
            ...
            SqlDataAdapter qInstruCJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC" +
                  " @jurisdiccionNLF ='" + ddlJuris.Text + "',@anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC='" + ddlQna.Text + "' ,@nominaConsultaFEAC ='" + ddlNomina.Text +
                  "' ,@urConsultaFEAC ='" + ddlUr.Text + "' ,@prdnameConsultaFEAC ='" + ddlPrd.Text + "',@instruConsultaFEAC ='" + ddlInstru.Text + "'", conexionBD);
            conexionBD.Open();
            ...
            else
            {
                ...
                SqlDataAdapter qInstruSJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "',@urConsultaFEAC ='" + ddlUr.Text + "',@prdnameConsultaFEAC='" + ddlPrd.Text + "',@instruConsultaFEAC ='" + ddlInstru.Text + "'", conexionBD);
                conexionBD.Open();
                ...
                else
                {
                    ...
                    SqlDataAdapter qInstruCJSI = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @jurisdiccionNLF ='" + ddlJuris.Text + "', @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "',@urConsultaFEAC ='" + ddlUr.Text + "',@prdnameConsultaFEAC='" + ddlPrd.Text + "'", conexionBD);
                    conexionBD.Open();
                    ...
                    else
                    {
                        ...
                        SqlDataAdapter qInstruSJSI = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "',@urConsultaFEAC ='" + ddlUr.Text + "',@prdnameConsultaFEAC='" + ddlPrd.Text + "'", conexionBD);
                        conexionBD.Open();
                        ...
                        {
                            DataTable dtPrdCJ = new DataTable();
                            SqlDataAdapter qPrdCJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @jurisdiccionNLF ='" + ddlJuris.Text + "', @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "',@urConsultaFEAC ='" + ddlUr.Text + "'", conexionBD);
                            conexionBD.Open();
                            ...
                            {
                                DataTable dtPrdSJ = new DataTable();
                                SqlDataAdapter qPrdSJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC  @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "',@urConsultaFEAC ='" + ddlUr.Text + "'", conexionBD);
                                conexionBD.Open();
                                ...
                                {
                                    DataTable dtUrCJ = new DataTable();
                                    SqlDataAdapter qUrCJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @jurisdiccionNLF ='" + ddlJuris.Text + "' ,@anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "'", conexionBD);
                                    conexionBD.Open();
                                    ...
                                    {
                                        DataTable dtUrSJ = new DataTable();
                                        SqlDataAdapter qUrSJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "',@nominaConsultaFEAC ='" + ddlNomina.Text + "'", conexionBD);
                                        conexionBD.Open();
                                        ...
                                        else
                                        {
                                            ...
                                            SqlDataAdapter qNomCJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @jurisdiccionNLF ='" + ddlJuris.Text + "' ,@anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "'", conexionBD);
                                            conexionBD.Open();
                                            ...
                                            else
                                            {
                                                ...
                                                SqlDataAdapter qNomSJ = new SqlDataAdapter("exec pry1015_ListadoFirmas_ConsultaFEAC @anioConsultaFEAC ='" + ddlAnio.Text + "',@qnaConsultaFEAC ='" + ddlQna.Text + "'", conexionBD);
                                                conexionBD.Open();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadodeFirmasCheques.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadodeFirmasCheques" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:Label ID="User" runat="server" Text='<%#Session["user"]%>' Visible="true"></asp:Label>
    ...
    <asp:Panel runat="server" ID="Listado_firmas_Cheques">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanel_ListadoFirmas_Cheques" runat="server">
                                    ...
                                    <div class="container-fluid">
                                                ...
                                                <div class="col-md-12 col-xs-12 col-lg-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:GridView CssClass="table table-striped" BackColor="White" BorderColor="#999999"
                                                            ...
                                                            Width="100%" Style="font-size: 13px" ID ="gvListadoDeFirmas_Cheques" runat="server"
                                                            ShowFooter="True" OnRowDataBound="gvListadoDeFirmas_Cheques_RowDataBound" AutoGenerateColumns="False">
                                        ...
                                        <br />
                                            <div id="dvBtnImpriListadodeFirmas" runat="server" visible="false">
                                                ...
                                                <asp:Button ID="BtnImpriListadodeFirmas" runat="server" CssClass="btn btn-primary" data-toggle="modal" data-target="#Confirmacion" Text="Imprimir listado de firma" OnClick="BtnImpriListadodeFirmas_Click" />

                                                <asp:Button id ="btnDescargaComprobante" runat="server" CssClass="btn btn-info" Text ="Descarga comprobante" OnClick="btnDescargaComprobante_Click" Visible=false/>
                                            </div>
                                        </div>
    ...
    <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanel_ListadoFirmas_Cheques">
        <ProgressTemplate>

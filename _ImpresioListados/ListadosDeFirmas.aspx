<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadosDeFirmas.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadosDeFirmas" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <script src="../Scripts/sweetalert.min.js"></script><link href="../css/sweetalert.css" rel="stylesheet" /><script type="text/javascript">
    ...
    </script><asp:Label ID="User" runat="server" Text='<%#Session["user"]%>' Visible="false"></asp:Label>
    <asp:Panel runat="server" ID="Listado_firmas">
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading" style="font-family: 'Yu Gothic UI Semibold'">
                     Impresión de listado de nómina generada
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanelListadoFirmas" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group col-xs-12 col-md-6 col-lg-2">
                                        ...
                                        <asp:DropDownList ID="ddlJURISid" runat="server"
                                            AppendDataBoundItems="True" AutoPostBack="True" CssClass="form-control"
                                            DataTextField="juris"
                                            OnSelectedIndexChanged="ddlJURISid_SelectedIndexChanged" align="center"
                                        ...
                                        <div id="dvMessagejURIS" runat="server" visible="false" class="alert alert-danger">
                                            <strong>Error:  </strong>
                                            <asp:Label ID="lblMensajeErrojURIS" runat="server" Text="" />
                                        </div>
                                    ...
                                    <div class="form-group col-xs-12 col-md-12 col-lg-12">
                                        <br />
                                        <asp:Button ID="Consultar" runat="server" OnClick="Consultar_Click" Text="Consultar" Height="35px" CssClass="btn btn-success" align="center" />
                                        ...
                                        <div class="container-fluid">
                                                ...
                                                <div class="col-md-12 col-xs-12 col-lg-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="font-family: 'Yu Gothic UI Semibold'">
                                                         ...
                                                         <asp:GridView ID="gvListadosDeFirmas" runat="server"
                                                           CssClass="table table-striped" BackColor="White" BorderColor="#999999"
                                                           BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical"
                                                           Width="100%" Style="font-size: 13px"
                                                           ShowFooter="True" OnRowDataBound="gvListadosDeFirmas_RowDataBound" AutoGenerateColumns="False">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Registros" ItemStyle-HorizontalAlign="Center">
                                                                   ...
                                                                   <asp:TemplateField HeaderText="tpersonal" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="columTpersonal" runat="server" Text='<%# Eval("totalPersonal" ,"{0:N0}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                            ...
                                            <div id="dvBtnImpriListadodeFirmas" runat="server" visible="false">
                                                ...
                                                <asp:Button ID="BtnImpriListadodeFirmas" runat="server" CssClass="btn btn-primary" data-toggle="modal" data-target="#Confirmacion" Text="Imprimir listado de firmas" OnClick="BtnImpriListadodeFirmas_Click" />
                                              
                                              <label runat ="server" id ="txt"></label>
                                        ...
                                        <div id="dvMsgFinal" runat="server" visible="false" class="alert alert-success">
                                            ...
                                            <asp:Label ID="MsgOk" runat="server" Text=""></asp:Label>
                                        </div>
                                        <div id="dvMsgFinalError" runat="server" visible="false" class="alert alert-danger">
                                            <strong>Error:: </strong>
        ...
        <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanelListadoFirmas">
            <ProgressTemplate>

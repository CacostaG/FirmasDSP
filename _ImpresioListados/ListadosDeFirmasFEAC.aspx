<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadosDeFirmasFEAC.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadosDeFirmasFEAC" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <script src="../Scripts/sweetalert.min.js"></script>
    ...
    <asp:Panel runat="server" ID="Listado_firmas">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanelListadosFirmasFEAC" runat="server">
                                    ...
                                    <div class="form-group col-xs-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="container-fluid">
                                                ...
                                                <div class="col-md-12 col-xs-12 col-lg-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:GridView ID="gvListadosDeFirmas" runat="server"
                                                            ...
                                                            ShowFooter="True" OnRowDataBound="gvTabla_RowDataBound" AutoGenerateColumns="False">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Póliza" ItemStyle-HorizontalAlign="Center">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="persona" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="columPersona" runat="server" Text='<%# Eval("persona") %>'></asp:Label>
                                                                    </ItemTemplate>
                                            ...
                                            <div id="dvBtnImpriListadodeFirmas" runat="server" visible="false">
                                             ...
                                             <asp:Button ID="BtnImpriListadodeFirmas" runat="server" CssClass="btn btn-primary" Text="Imprimir listado de firmas" OnClick="BtnImpriListadodeFirmas_Click" />

                                             <asp:Button ID="btnDescargaConstancia" runat="server" CssClass="btn btn-info" Text ="Descargar constancias" OnClick="btnDescargaConstancia_Click"/> 
        ...
        <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanelListadosFirmasFEAC">
            <ProgressTemplate>

...
{
    public partial class ListadosDeFirmasMedidasFinAnio : System.Web.UI.Page
    {
        ...
        {
            ddlJurisMFA.Items.Clear();
            ddlJurisMFA.Items.Add("Selecciona");
            SqlCommand cmdJuririsdiccionMFA = new SqlCommand("exec Pry1015_ParametrosImpresionMedidasFinAnio_ClaveJuris", conexionBD);
            SqlDataAdapter sdJurisdiccionMFA = new SqlDataAdapter(cmdJuririsdiccionMFA);
            DataTable dtJurisdiccionAMF = new DataTable();
            sdJurisdiccionMFA.Fill(dtJurisdiccionAMF);
            ddlJurisMFA.DataSource = dtJurisdiccionAMF;
            ddlJurisMFA.DataBind();
            dvBtnImpriListadodeFirmas.Visible = false;
        }



        protected void ddlJurisMFA_SelectedIndexChanged(object sender, EventArgs e)
        {

            if (ddlJurisMFA.SelectedItem.Text == "Selecciona")
            {
                ddlAnioMFA.Enabled = false;
            ...
            else
            {
                ...
                ddlAnioMFA.Enabled = true;
                ddlAnioMFA.Items.Clear();
                ddlAnioMFA.Items.Add("Selecciona");

                SqlCommand cmdAnioMFA = new SqlCommand("EXEC Pry1015_ParametrosImpresionMedidasFinAnio_Ejercicio @ClaveJuris = '" + ddlJurisMFA.Text + "'", conexionBD);
        ...
        protected void ddlAnioMFA_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmdLoteMFA = new SqlCommand("EXEC Pry1015_ParametrosImpresionMedidasFinAnio_Lote @anio='" + ddlAnioMFA.Text + "' , @ClaveJuris='" + ddlJurisMFA.Text + "'", conexionBD);
        ...
        protected void BindGridView()
        {
            ...
            SqlDataAdapter consultaGenralMedidasFinAnio = new SqlDataAdapter("Pry1015_ImpresionMedidaFinAnio_Busqueda @ClaveJuris='" + ddlJurisMFA.Text + "', @anio='" + ddlAnioMFA.Text + "', @lote='" + ddlLoteMFA.Text + "'", conexionBD);
            conexionBD.Open();

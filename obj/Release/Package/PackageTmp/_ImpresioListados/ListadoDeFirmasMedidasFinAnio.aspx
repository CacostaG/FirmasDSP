<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoDeFirmasMedidasFinAnio.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadoDeFirmasMedidasFinAnio" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server" ID="Medidas_Fin_Año">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanel_ListadoMedidasFinAnio" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group col-xs-12 col-md-6 col-lg-2">
                                        ...
                                        <asp:DropDownList ID="ddlAnioMFA" runat="server"
                                    ...
                                    <div class="form-group col-xs-12 col-md-6 col-lg-2">
                                        ...
                                        <asp:DropDownList ID="ddlLoteMFA" runat="server"
                                            AppendDataBoundItems="True" DataTextField="lote" CssClass="form-control" align="center" AutoPostBack="True"
                                            Enabled="false">
                                            <asp:ListItem Value="0">Selecciona</asp:ListItem>
                                        </asp:DropDownList>
        ...
        <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanel_ListadoMedidasFinAnio">
            <ProgressTemplate>

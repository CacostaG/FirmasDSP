<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaNominaGenerada.aspx.cs" Inherits="ListadoDeFirmasDSP._Consulta.ConsultaNominaGenerada"  EnableEventValidation="false" %>
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading" style="font-family: 'Yu Gothic UI Semibold'">
                Consulta de listados de nómina generados
            </div>


            <div class="panel-body">
                <div class="row col-lg-12">
                    <asp:UpdatePanel ID="updatePanelConsultaNomina" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <form class="form-inline">
                                ...
                                <div class="form-group col-lg-2 col-md-6 col-lx-12">
                                    ...
                                    <asp:DropDownList ID="ddlAnio" runat="server"
                                       AutoPostBack="true" CssClass="form-control" Enabled="false"
                                ...
                                <div class="form-group  col-lg-2 col-md-6 col-lx-12">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlQna" CssClass="form-control"
                                        Autopostback="true" AppendDataBoundItems="true" Enabled="false"
                                        DataTextField="qna" aling="center"
                                        UseSubmitBehavior="false" OnSelectedIndexChanged="ddlQna_SelectedIndexChanged">
                                        <asp:ListItem Value="0">Selecciona</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="form-group  col-lg-2 col-md-6 col-lx-12">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlNomina" CssClass="form-control"
                                        Autopostback="true" AppendDataBoundItems="true" Enabled="false"
                                        DataTextField="nomina" aling="center"
                                        UseSubmitBehavior="false" OnSelectedIndexChanged="ddlNomina_SelectedIndexChanged">
                                        <asp:ListItem Value="0">Selecciona</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div class="form-group  col-lg-4 col-md-6 col-lx-12">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlUr" CssClass="form-control"
                                        Autopostback="true" AppendDataBoundItems="true" Enabled="false"
                                        DataTextField="ur" aling="center"
                                        UseSubmitBehavior="false" OnSelectedIndexChanged="ddlUr_SelectedIndexChanged">
                                        <asp:ListItem Value="0">Selecciona</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                 ...
                                 <div class="form-group  col-lg-4 col-md-6 col-lx-12">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlPrd" CssClass="form-control"
                                        Autopostback="true" AppendDataBoundItems="true" Enabled="false"
                                        DataTextField="prdname" aling="center"
                                        UseSubmitBehavior="false" OnSelectedIndexChanged="ddlPrd_SelectedIndexChanged">
                                        <asp:ListItem Value="0">Selecciona</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
     ...
     <asp:UpdateProgress ID="up1" runat="server" AssociatedUpdatePanelID="updatePanelConsultaNomina">
        <ProgressTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoDeFirmasFEAC.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadoDeFirmasFEAC"  EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <script src="../Scripts/sweetalert.min.js"></script>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanel_ListadoFirmasFEAC" runat="server">
                                 ...
                                 <div class="form-group col-xs-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div id="dvBtnImpriListadodeFirmas" runat="server" visible="false">
                                            ...
                                            <asp:Button ID="btnDescargaTicket" runat="server" CssClass="btn btn-info" Text="Descargar comprobante" OnClick="btnDescargaTicket_Click" Visible="false" />
                                            <asp:Button ID="btnDescargaCedula" runat="server" CssClass="btn btn-primary" Text="Descargar constancias" OnClick="btnDescargaCedula_Click" Visible="false" />
                                            <asp:Button ID="btnDescargaTicketCedula" runat="server" Text="Descargar comprobante de constancias" Visible="false" CssClass="btn btn-info" OnClick="btnDescargaTicketCedula_Click"/>
                                        </div>
                                        </div>   
    ...
    <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanel_ListadoFirmasFEAC">
        <ProgressTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadosdeFirmasCheques.aspx.cs" Inherits="ListadoDeFirmasDSP._ImpresioListados.ListadosdeFirmasCheques" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="User" runat="server" Text='<%#Session["user"]%>' Visible="false"></asp:Label>
        ...
        <asp:Panel runat="server" ID="Listado_firmasCheques">
            <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading" style="font-family: 'Yu Gothic UI Semibold'">
                    Impresión de  listado de cheques
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row col-lg-12">
                        <!--A_Panel--->
                        <asp:UpdatePanel ID="UpdatePanelListadoFirmas_Cheques" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12 col-lg-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:GridView CssClass="table table-striped" BackColor="White" BorderColor="#999999"
                                                            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical"
                                                            Width="100%" Style="font-size: 13px" ID ="gvListadosDeFirmas_Cheques" runat="server"
                                                            ShowFooter="True" OnRowDataBound="gvListadosDeFirmas_Cheques_RowDataBound" AutoGenerateColumns="False">
      ...
      <asp:UpdateProgress ID="UpdateProgress" runat="server" AssociatedUpdatePanelID="UpdatePanelListadoFirmas_Cheques">
            <ProgressTemplate>
